...
This script uses the GraphRAG API directly to process The Hobbit PDF and
...
from src.visualization.interactive_visualizer import create_3d_visualization
...
def generate_visualizations(atlas, output_dir):
    ...
    viz_3d_path = os.path.join(output_dir, "hobbit_3d.html")
    create_enhanced_hobbit_visualization(atlas, viz_3d_path)
    
    # Create interactive visualization
    print("Creating interactive visualization...")
    interactive_path = os.path.join(output_dir, "hobbit_interactive.html")
    create_3d_visualization(atlas, interactive_path)
...
<body>
    ...
    <div class="viz-container">
        ...
        <a href="hobbit_3d.html" class="viz-link">3D Visualization</a>
        <a href="hobbit_interactive.html" class="viz-link">Interactive Explorer</a>
""")
...
def main():
    ...
    index_data = graphrag_api.build_index(
        project_dir,
        verbose=True,
        cache=True
    )
